...
const BottomNav = () => {
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="fixed left-0 top-0 hidden h-screen w-64 border-r border-slate-100 bg-white p-6 shadow-sm lg:flex lg:flex-col">
      ...
      {/* Mobile Navigation */}
      <nav className="fixed bottom-0 left-0 z-50 w-full border-t border-slate-100 bg-white/95 px-6 py-3 shadow-lg backdrop-blur-md lg:hidden">
